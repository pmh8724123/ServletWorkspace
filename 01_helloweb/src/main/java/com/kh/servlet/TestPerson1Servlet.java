...
public class TestPerson1Servlet extends HttpServlet {
     ...
     *  
     *  - 사용자의 요청을 받아 처리하고, 그에 해당하는 응답페이지를 만들어서 
     *    다시 사용자에게 응답하는 역할을 하는 자바 클래스.(Controller)
     *  
     *  - 웹에서 동적인 페이지를 자바를 통해 구현할 수 있게 도와주는 서버측 프로그램
     *  
     * Servlet 생명주기
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/* 
		 * HttpServletRequest
		 *  - 서비스 요청시 사용자가 전송한 입력값, 요청전송방식, URL 등
		...
		// 동일한 key갑으로 여러개의 값이 전달된 경우, getParametervalues
